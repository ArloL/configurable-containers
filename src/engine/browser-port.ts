...
// docs/e2e-and-probe.md forbids a build-time seed that ARMS a container, because that would
// make the shipped extension capable of starting up with routing disabled; an echo changes
// no routing and can only describe what already happened.
