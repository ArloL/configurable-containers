...
// The naming rule itself is `src/resolver/types.ts`'s, and its cases are
// `test/resolver/throwaway-name.test.ts` — inside the mutation gate, which this file is not.
import { TMP_PREFIX } from "../../src/resolver/types";
